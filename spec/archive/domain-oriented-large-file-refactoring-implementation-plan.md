...
- [x] NW-LF-24 `src/modules/nightworkers/components/NightWorkersShell.tsx` (1141 → 560): route/layoutを`NightWorkersShellLayout.tsx`、project/session selectionを`useNightWorkersProjectNavigation.ts`、composer/questionnaire stateを専用hookへ分離し、shellを合成層へ縮小した。
