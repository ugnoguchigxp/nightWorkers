...
export async function safelyRefreshConversationContext(input: RefreshConversationContextInput) {
...
export async function safelyCreateReviewRecommendation(input: { taskId: string; runId: string }) {
  try {
