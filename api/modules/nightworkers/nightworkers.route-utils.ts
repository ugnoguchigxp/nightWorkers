...
export type NightWorkersRouteHandler<ContextType extends NightWorkersRouteContext> = (
  c: ContextType
...
export function routeErrorResponse<ContextType extends NightWorkersRouteContext>(
  c: ContextType,
  err: unknown
): never {
