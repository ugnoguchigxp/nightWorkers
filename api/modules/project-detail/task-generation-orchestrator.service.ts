...
import * as projectDetailService from "./project-detail.service";
import { buildProjectSignalSnapshot } from "./project-signal-snapshot.service";
...
type TaskGenerationDependencies = {
	...
	listMissionGoals: typeof projectDetailRepo.listMissionGoals;
	buildProjectSignalSnapshot: typeof buildProjectSignalSnapshot;
	callStructuredJsonLLM: typeof callStructuredJsonLLM;
	generateMissionTaskCandidates: typeof projectDetailService.generateMissionTaskCandidates;
...
const defaultDependencies: TaskGenerationDependencies = {
	...
	listMissionGoals: projectDetailRepo.listMissionGoals,
	buildProjectSignalSnapshot,
	callStructuredJsonLLM,
	generateMissionTaskCandidates:
		projectDetailService.generateMissionTaskCandidates,
