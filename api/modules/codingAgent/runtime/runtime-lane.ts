...
export function readRuntimeLaneConfigFromEnv(
	...
	return {
		...
		RuntimeLaneInput,
		"envRuntimeLane" | "envActiveLlmProvider" | "envCodexEnabled"
	>;
}

export function resolveRuntimeLane(
	input: RuntimeLaneInput = {},
...
export function normalizeRuntimeLane(value: unknown): RuntimeLane | null {
	if (
		value === "native-api-runner" ||
		value === "native-supervisor" ||
		value === "native-local"
	) {
...
function isLegacyRuntimeLaneAlias(value: unknown, lane: RuntimeLane) {
	return (
		((value === "native-supervisor" || value === "native-local") &&
			lane === "native-api-runner") ||
