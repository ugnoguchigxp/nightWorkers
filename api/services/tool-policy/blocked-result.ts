...
function emptyPayloadByTool(
	...
	if (toolName === "search_files")
		return { matches: [], count: 0, engine: "ripgrep" };
	...
	if (toolName === "replace_content")
		return { applied: false, occurrences: 0, filePath: "" };
	...
	if (toolName === "mcp_call_tool")
		return { serverId: "", toolName: "", result: null };
