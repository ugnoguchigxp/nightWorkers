...
export const BUILTIN_RUBRICS: Record<string, RubricDefinition> = {
	"basic-coding-run": {
		...
		description:
			"Diff, final report, verification, policy, and repeated failure checks.",
		scope: {},
		criteria: [
			{
				id: "diff-present",
	...
	"review-ready-run": {
		...
		description:
			"Checks that a needs_review run has review evidence available.",
		scope: {},
		criteria: [
			{
			...
			},
			{
				...
				evaluationMode: "deterministic",
				evidenceSelectors: [
					{ kind: "review_followup", requiredForBlocking: true },
				],
				rule: { required: true, failWhenMissing: true },
			},
			{
