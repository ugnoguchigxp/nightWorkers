...
export const MISSION_PILOT_PLAN_ENTRY_CONTEXT =
	"Mission PilotはPlan ModeのArtifactを提案・選択・生成せず、Questionnaireの作成・回答・確定も行いません。設計が必要なTaskでは、ユーザーと同じTask messageまたはrun開始操作を使ってCoding Agentへ依頼し、Coding Agentの入力要求や結果を待ってください。";
