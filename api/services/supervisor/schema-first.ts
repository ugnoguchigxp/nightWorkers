						...
						anyOf: [
							{
								...
								properties: {
									...
									dedicatedViews: {
										...
										items: {
											...
											properties: {
												view: {
													type: "string",
													enum: dedicatedDesignViewSchema.options,
												},
									...
									specificationLenses: {
										...
										items: {
											type: "string",
											enum: specificationLensSchema.options,
										},
									},
								},
							},
						...
						anyOf: [
							{
								...
								properties: {
									executionType: {
										type: "string",
										enum: ["normal", "exclusive", "sequence"],
									},
									reason: { type: "string" },
									sequenceGroupId: {
...
export function parseSupervisorOutput(raw: unknown, round?: 1 | 2) {
	return round === 1
		? jobTypeSelectionSchema.parse(raw)
		: toolCallEnvelopeSchema.parse(raw);
}
