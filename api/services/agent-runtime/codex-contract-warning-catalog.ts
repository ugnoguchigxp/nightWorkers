export const CODEX_CONTRACT_WARNING_CATALOG = {
	...
	codex_unexpected_nightworkers_mcp_tool: {
		...
		terminalPolicy: "none",
		description:
			"A NightWorkers MCP tool outside the manifest source of truth was observed.",
	},
	codex_mcp_degraded: {
		defaultSeverity: "warning",
		terminalPolicy: "none",
	...
	codex_global_mcp_tool_observed: {
		...
		terminalPolicy: "none",
		description:
			"A non-NightWorkers MCP tool was observed in the Codex runtime lane.",
	},
	...
	codex_high_risk_native_import_command: {
		...
		description:
			"A native command looked like a high-risk project import alternative.",
	},
	...
	codex_file_change_without_current_todo: {
		...
		terminalPolicy: "none",
		description:
			"Codex changed files while no current running Todo evidence was found.",
	},
	codex_todo_evidence_db_read_failed: {
		defaultSeverity: "warning",
		terminalPolicy: "none",
		description:
			"Todo evidence DB read failed and runtime context fallback was used if available.",
	},
	...
	codex_file_change_without_prior_read: {
		...
		terminalPolicy: "none",
		description:
			"Codex changed files without observable read evidence for the target path.",
	},
	codex_todo_progress_missing: {
		defaultSeverity: "warning",
		terminalPolicy: "none",
		description:
			"Codex performed work before any nightworkers.todo_list progress mutation.",
	},
	codex_todo_progress_list_only: {
		defaultSeverity: "warning",
		terminalPolicy: "none",
		description:
			"Codex called nightworkers.todo_list operation=list without progress mutation.",
	},
	...
	codex_file_change_while_mcp_degraded: {
		...
		terminalPolicy: "none",
		description:
			"Codex changed files after NightWorkers MCP degradation was observed.",
	},
	...
	codex_plan_mode_mutating_tool: {
		...
		terminalPolicy: "needs_human",
		description:
			"Codex used a mutating NightWorkers MCP tool during a planning run.",
	},
	codex_runtime_resume_failed: {
		defaultSeverity: "warning",
		terminalPolicy: "none",
		description:
			"Codex runtime session resume failed and a fresh thread was started.",
	},
...
export type CodexContractWarningCode =
	keyof typeof CODEX_CONTRACT_WARNING_CATALOG;
