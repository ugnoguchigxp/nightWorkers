...
function buildNativeApiSystemPrompt(context: AgentRunContext) {
	...
	return [
		...
		"- startup gates normally handle context_initial_instructions and context_compile before provider work. If a matching contextStill procedure Todo is current and its tool is visible, execute that procedure.",
