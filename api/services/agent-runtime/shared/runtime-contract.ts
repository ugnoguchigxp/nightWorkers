...
export function normalizeRuntimeContractWarnings(value: unknown): RuntimeContractWarning[] {
...
export function dedupeRuntimeContractWarnings(warnings: RuntimeContractWarning[]) {
...
export function mergeRuntimeContractSnapshot(
  ...
  const mergedWarnings = dedupeRuntimeContractWarnings([...existingWarnings, ...warnings]);
