...
import type { McpServerConfig, McpServerSettingsDiagnostic } from '../mcp/mcp-config-schema';
...
function readMcpServersObject(config: Record<string, unknown>): Record<string, unknown> | null {
