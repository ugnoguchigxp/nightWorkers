...
const blueprintLayoutWidthSchema = z.enum([
	"auto",
	"full",
	"1/2",
	"1/3",
...
const blueprintLayoutAlignSchema = z.enum([
	"start",
	"center",
	"end",
	"stretch",
...
const blueprintLayoutKindSchema = z.enum([
	"stack",
	"row",
	"grid",
	"split",
...
export const blueprintSectionOverrideSchema = z
	...
	.superRefine((override, ctx) => {
		if (override.set || override.insert || override.remove || override.replace)
			return;
		ctx.addIssue({
			code: "custom",
...
export type BlueprintSectionOverride = z.infer<
	typeof blueprintSectionOverrideSchema
>;
export type BlueprintSectionRegion = z.infer<
	typeof blueprintSectionRegionSchema
>;
export type BlueprintScreenLayout = z.infer<typeof blueprintScreenLayoutSchema>;
export type ComponentBlueprintSection = z.infer<
	typeof componentBlueprintSectionSchema
>;
export type PresetBlueprintSection = z.infer<
	typeof presetBlueprintSectionSchema
>;
export type CustomBlueprintSection = z.infer<
	typeof customBlueprintSectionSchema
>;
