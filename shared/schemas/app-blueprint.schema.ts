...
export const appBlueprintSchema = z
  .object({
    ...
    databaseSchema: blueprintDatabaseSchema.default({ tables: [], relations: [] }),
...
export type BlueprintImplementationTask = z.infer<typeof blueprintImplementationTaskSchema>;
