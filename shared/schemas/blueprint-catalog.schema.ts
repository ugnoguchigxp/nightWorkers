...
export const blueprintComponentPlacementSchema = z.enum([
	"page",
	"section",
	"shell",
	"primitive",
...
export type BlueprintComponentName = z.infer<
	typeof blueprintComponentNameSchema
>;
export type BlueprintComponentPlacement = z.infer<
	typeof blueprintComponentPlacementSchema
>;
export type BlueprintDataSourceKind = z.infer<
	typeof blueprintDataSourceKindSchema
>;
export type BlueprintComponentDefinition = z.infer<
	typeof blueprintComponentDefinitionSchema
>;
