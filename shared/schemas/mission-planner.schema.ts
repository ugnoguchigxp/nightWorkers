...
export type MissionPlanningResultStatus = z.infer<
	typeof missionPlanningResultStatusSchema
>;

export const missionTaskProposalStatusSchema = z.enum([
	"proposed",
	"task_created",
	"dismissed",
]);
export type MissionTaskProposalStatus = z.infer<
	typeof missionTaskProposalStatusSchema
>;
...
export type MissionDeterministicCheckReport = z.infer<
	typeof missionDeterministicCheckReportSchema
>;
...
export type MissionEvaluationDimensionKey = z.infer<
	typeof missionEvaluationDimensionKeySchema
>;

export const missionDecompositionEvaluationSchema = z
	.object({
		schemaVersion: z.literal(
			"nightworkers.mission-decomposition-evaluation/v1",
		),
		verdict: z.enum([
			"review_ready",
			"needs_clarification",
...
export type MissionDecompositionEvaluation = z.infer<
	typeof missionDecompositionEvaluationSchema
>;
...
export type MissionDecompositionRun = z.infer<
	typeof missionDecompositionRunSchema
>;
...
export type MissionProposalTaskMetadata = z.infer<
	typeof missionProposalTaskMetadataSchema
>;
...
export type DecomposeMissionRequest = z.infer<
	typeof decomposeMissionRequestSchema
>;
