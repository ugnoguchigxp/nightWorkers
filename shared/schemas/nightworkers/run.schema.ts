...
export const taskRunTodoSchema = z
	.object({
		...
		nextAction: z.string(),
		acceptanceCriteriaJson: z.array(z.string()),
		...
		systemContextVersion: z.number().int().nonnegative(),
		systemContextSnapshot: jsonValueSchema.nullable().optional(),
		createdBy: z.enum(["agent", "human", "migration"]),
