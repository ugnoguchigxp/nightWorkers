...
export type ProjectEvaluationDimensionKey = z.infer<
	typeof projectEvaluationDimensionKeySchema
>;
...
export const projectEvaluationDimensionLabels: Record<
...
export type ProjectEvaluationEvidenceLevel = z.infer<
	typeof projectEvaluationEvidenceLevelSchema
>;

export const projectEvaluationRunStatusSchema = z.enum([
	"running",
	"completed",
	"failed",
]);
export type ProjectEvaluationRunStatus = z.infer<
	typeof projectEvaluationRunStatusSchema
>;
...
export type ProjectEvaluationDimensionScore = z.infer<
	typeof projectEvaluationDimensionScoreSchema
>;

export const projectEvaluationReportDimensionSchema =
	projectEvaluationDimensionScoreSchema.omit({
		id: true,
		evaluationId: true,
		delta: true,
	});

const fixedProjectEvaluationDimensionSet =
	new Set<ProjectEvaluationDimensionKey>(fixedProjectEvaluationDimensions);
...
export type ProjectEvaluationBundle = z.infer<
	typeof projectEvaluationBundleSchema
>;
...
export const projectEvaluationReportSchema = z
	...
	.superRefine((report, ctx) =>
		validateFixedProjectEvaluationDimensions(report.dimensions, ctx),
	)
...
export type ProjectImprovementScoreImpact = z.infer<
...
export type ProjectImprovementIdea = z.infer<
	typeof projectImprovementIdeaSchema
>;
	...
	ideas: z
		.array(
			projectImprovementIdeaSchema
				...
				.extend({
					scoreImpacts: z.array(focusedImprovementScoreImpactSchema).min(1),
				}),
		)
		.min(1),
});
...
export type ProjectEvaluationActivityEvent = z.infer<
	typeof projectEvaluationActivityEventSchema
>;
...
export type ProjectEvaluationTaskLink = z.infer<
	typeof projectEvaluationTaskLinkSchema
>;

export const createProjectEvaluationRequestSchema = z.object({
	baselinePrompt: z.string().trim().min(1).optional(),
});
export type CreateProjectEvaluationRequest = z.infer<
	typeof createProjectEvaluationRequestSchema
>;
...
export const projectEvaluationDetailSchema = z.object({
	...
	improvements: z.array(
		projectImprovementIdeaSchema.required({ id: true, evaluationId: true }),
	),
	activityEvents: z.array(projectEvaluationActivityEventSchema),
	taskLinks: z.array(projectEvaluationTaskLinkSchema),
});
export type ProjectEvaluationDetail = z.infer<
	typeof projectEvaluationDetailSchema
>;
...
export type StartProjectEvaluationResponse = z.infer<
	typeof startProjectEvaluationResponseSchema
>;
...
export type ProjectEvaluationActivityReplay = z.infer<
	typeof projectEvaluationActivityReplaySchema
>;
