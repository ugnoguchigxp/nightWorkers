...
vi.mock('../api/modules/nightworkers/nightworkers.plan-mode-settings.service', () => ({
...
vi.mock('../api/modules/specification/specification-questionnaire-session', () => ({
