...
const allowedMatches = new Set(['src/modules/nightworkers/components/ArtifactPane.tsx:db-design']);

const allowedExtensions = new Set(['.css', '.cjs', '.js', '.json', '.md', '.mjs', '.tsx', '.ts']);
