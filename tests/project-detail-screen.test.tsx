...
describe("TaskGenerationTreeTable", () => {
	...
	it("counts a Mission for every linked Goal, not only the first source Goal", () => {
		const otherGoalId = "88888888-8888-4888-8888-888888888888";
		expect(
			countMissionsForGoal(
				[{ ...mission, sourceGoalIds: [otherGoalId, goal.id] }],
				goal.id,
			),
		).toBe(1);
	});
