			...
			sections: [
				{
					...
					props: {
						...
						description:
							"Highlights the strongest operational cues before opening a task.",
						items: [
				...
				},
				{
					...
					props: {
						...
						description:
							"Keeps the next review action visible in a compact work surface.",
						columns: [
	...
	implementationTasks: [
		{
			...
			description:
				"Build the designed command center screen and preview states.",
