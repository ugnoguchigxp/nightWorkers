  ...
  screens: [
    {
      ...
      path: '/',
      purpose: 'Review the current workload and decide the next operational action.',
      ...
      sections: [
        {
          ...
          copy: {
            title: 'Workspace',
            description: 'Fast access to the operational areas used during review.',
          },
          dataset: {
            kind: 'navigation',
            items: [
        ...
        },
        {
          ...
          copy: {
            ...
            description: 'Work items that need confirmation before implementation can proceed.',
