...
const importProjectPayload = {
	...
	template: {
		...
		gitOperations: [
			{
				command:
					"git clone --depth 1 https://github.com/ugnoguchigxp/hono-standard.git repo",
					...
					data: {
						...
						result: {
							content: [
								{
									type: "text",
									text: JSON.stringify(importProjectPayload, null, 2),
								},
							],
						},
					},
							...
							data: {
								...
								result: {
									content: [
										{
											type: "text",
											text: JSON.stringify(importProjectPayload),
										},
									],
								},
							},
