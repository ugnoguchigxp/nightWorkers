export const jaTodoPane = {
	...
	"todoPane.runtimePauseDescription":
		"Runtimeのresource上限で停止しました。追加Contextを入力して同じTodoを再開できます。",
	"todoPane.resumePlaceholder": "質問への回答や判断内容を入力",
	"todoPane.resumeAction": "この Todo を再開",
	"todoPane.resuming": "再開しています…",
} as const;
