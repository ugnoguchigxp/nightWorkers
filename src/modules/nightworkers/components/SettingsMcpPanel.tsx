...
import { emptyMcpForm, formFromMcpServer, type McpServerForm } from './SettingsForms';

type SettingsMcpPanelProps = {
  ...
  mcpPasteText: string;
  setMcpPasteText: Dispatch<SetStateAction<string>>;
  toggleMcpServer: (server: McpServerConfig, enabled: boolean) => Promise<void>;
  importMcpServers: () => Promise<void>;
