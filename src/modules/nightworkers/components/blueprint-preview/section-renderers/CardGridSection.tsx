...
import { previewColumns, previewImageAlt, previewImageFor, toObjectArray } from '../previewModel';
import type { SectionRendererInput } from './types';

export function renderCardGridSection({ componentName, props, t }: SectionRendererInput) {
