...
export function createBlueprintPreviewDesignSettings(
  ...
  return {
    ...
    motion: pickOption(designPreset.motion, motions, defaultBlueprintPreviewDesignSettings.motion),
    componentVariants: {
      button: pickOption(
...
export function designReferenceSummary(settings: BlueprintPreviewDesignSettings): string {
  return [
...
function normalizeFont(value: unknown): BlueprintPreviewDesignSettings['font'] {
  if (value === 'small' || value === 'default' || value === 'large') return 'geist';
...
function cloneDefaultSettings(): BlueprintPreviewDesignSettings {
  return {
    ...
    componentVariants: { ...defaultBlueprintPreviewDesignSettings.componentVariants },
  };
}
