...
export function buildPersistedScrollState(snapshot: ScrollSnapshot): PersistedScrollState {
...
export function loadPersistedScrollState(sessionId: string): PersistedScrollState | null {
...
export function persistScrollState(sessionId: string, state: PersistedScrollState) {
...
export function restoreScrollState(element: HTMLDivElement, state: PersistedScrollState) {
