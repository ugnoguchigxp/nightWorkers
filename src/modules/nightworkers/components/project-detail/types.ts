...
export type ProjectDetailTab = 'overview' | 'mission' | 'evaluation' | 'quality' | 'stack';
...
export type CandidateRowSource = 'mission_task_candidate' | 'mission_task_proposal';
...
export type UnifiedTaskCandidateStatus = 'candidate' | 'task_created' | 'dismissed';
...
export type GoalDraft = { id?: string; title: string; goalText: string; active: boolean };
