		...
		<section className="space-y-3">
			...
			<div className="grid gap-3 md:grid-cols-3">
				...
				<KpiTile
					...
					value={t(
						`projectDetail.stack.manifestStatus.${stackProfile.manifestStatus}`,
					)}
					sub={projectPath}
				/>
			</div>
						...
						<thead style={subtleTextStyle}>
							<tr>
								<th className="py-2 pl-4 text-left">
									{t("projectDetail.field.technology")}
								</th>
								<th className="py-2 text-left">
									{t("projectDetail.field.category")}
								</th>
								<th className="py-2 text-left">
									{t("projectDetail.field.source")}
								</th>
								<th className="py-2 text-left">
									{t("projectDetail.field.version")}
								</th>
							...
							{stackProfile.technologies.length > 0 ? (
								stackProfile.technologies.map((technology) => (
									...
									>
										...
										<td className="py-3">
											{t(`projectDetail.stack.source.${technology.source}`)}
										</td>
										...
										<td className="py-3 pr-4 text-right">
											{t(
												`projectDetail.stack.confidence.${technology.confidence}`,
											)}
										</td>
									</tr>
								))
								...
								<EmptyTableRow
									colSpan={5}
									message={t("projectDetail.stack.empty")}
								/>
							)}
						</tbody>
					</table>
