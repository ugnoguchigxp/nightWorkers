...
export function renderKanbanSection({ componentName, props, t }: SectionRendererInput) {
  ...
  const rowCount = Math.min(Math.max(...visibleColumns.map((column) => column.cards.length), 0), 5);
