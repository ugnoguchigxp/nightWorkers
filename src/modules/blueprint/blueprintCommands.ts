...
export function fetchBlueprintAdoption(sessionId: string, messageId: string, init?: RequestInit) {
  return apiFetch(
...
export function saveBlueprintAdoption(
  ...
  return apiFetch(`/api/tasks/${sessionId}/blueprint-adoption`, jsonRequest('PUT', input));
}
