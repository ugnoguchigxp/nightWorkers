...
export function fetchDesignQuestionnaireSessions(
	sessionId: string,
	init?: RequestInit,
) {
...
export function fetchDesignQuestionnaireSession(
	...
	return apiFetch(
		`/api/tasks/${sessionId}/design-questionnaire/${questionnaireSessionId}`,
		init,
	);
}
...
export function startDesignQuestionnaire(
	...
	return apiFetch(
		`/api/tasks/${sessionId}/design-questionnaire`,
