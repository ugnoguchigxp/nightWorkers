					...
					<div className="flex items-center justify-between gap-3">
						<div>
							...
							<p className="mt-1 text-xs text-zinc-500">
								LLM provider endpoints and credentials. Role Routing selects
			...
			{section === "routing" ? (
				<section className="space-y-4 rounded-2xl border border-zinc-800/60 bg-[#16161a] p-6">
					<div>
						...
						<p className="mt-1 text-xs text-zinc-500">
							Select model targets. Each option includes the model and its
							provider endpoint.
						</p>
					</div>
					<div className="grid gap-3">
				...
				<section className="space-y-4 rounded-2xl border border-zinc-800/60 bg-[#16161a] p-6">
					<div className="flex items-start justify-between gap-3">
						<div>
							...
							<p className="mt-1 text-xs text-zinc-500">
								Codex login and model options are read from the local Codex
								configuration.
							</p>
						</div>
						<Button
