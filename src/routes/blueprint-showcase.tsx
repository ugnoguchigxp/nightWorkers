...
import '../modules/nightworkers/components/blueprint-preview/blueprintPreview.css';

export const Route = createFileRoute('/blueprint-showcase')({
  component: BlueprintShowcasePage,
...
function BlueprintShowcasePage() {
  return (
        ...
        <header className="grid min-w-0 gap-5 border-zinc-800 border-b pb-6">
          ...
          <div className="grid gap-3">
            ...
            <p className="max-w-3xl text-sm leading-6 text-zinc-400">
              Current section components accepted by the Blueprint catalog.
            </p>
          </div>
...
function BlueprintShowcaseError() {
  return (
    <div className="min-h-screen bg-[#141416] px-6 py-10 text-zinc-100">
      <div className="mx-auto max-w-2xl rounded-md border border-red-900/60 bg-red-950/30 p-5">
        <h1 className="font-semibold text-lg text-white">Blueprint showcase failed to render.</h1>
        <p className="mt-2 text-sm leading-6 text-red-100">
          The section catalog could not be loaded in this route.
        </p>
      </div>
    </div>
  );
